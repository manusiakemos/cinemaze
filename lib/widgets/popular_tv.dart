      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text("MOST POPULAR TV SERIES", style: MyHeading(headingStyleCustom: HeadingStyle.m)),
              TextButton(
                  child: Text("Show All",
                  ...
                  onPressed: (){
                    ...
                    Navigator.push(context,
                        CupertinoPageRoute(builder: (context) => AllMovieScreen(isMovie: false,))
                    );
                  }
              )
            ],
        ...
        Container(
            ...
            child: FutureBuilder(
              future: httpService.fetchPopularTv(),
